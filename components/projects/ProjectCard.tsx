      ...
      <div className="min-w-0 flex-auto">
        ...
        <div className="mt-3 flex items-center gap-x-2.5 text-xs leading-5 text-gray-400">
          <div className="truncate">
            <Link href={`${SEPOLIA_ETHERSCAN_URL}/address/${role === 'po' ? project.kol : project.owner}`} target="_blank" className="underline inline-flex justify-center items-center">
          ...
          <>
            <Link href={`https://twitter.com/${project.kolTwitterHandle}`} target="_blank">
              <span className="inline-flex justify-center items-center space-x-1 underline">
