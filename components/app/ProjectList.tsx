          ...
          <li key={Math.random()} className="relative flex items-center space-x-4 px-4 py-4 sm:px-6 lg:px-8">
            <div className="min-w-0 flex-auto">
              ...
              <div className="mt-3 flex items-center gap-x-2.5 text-xs leading-5 text-gray-400">
                ...
                {role === 'po' && (
                  <>
                    <Link href={`https://twitter.com/${project.kolTwitterHandle}`} target="_blank" className="hover:underline">
                      <span className="inline-flex justify-center items-center space-x-1">
                        ...
                        {' '}
                        <span className="hover:underline">{project.kolTwitterHandle}</span>
                      </span>
                    </Link>
                    <svg viewBox="0 0 2 2" className="h-0.5 w-0.5 flex-none fill-gray-300">
                      <circle cx={1} cy={1} r={1} />
