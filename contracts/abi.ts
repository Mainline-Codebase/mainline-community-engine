export const abi = [{ inputs: [{ internalType: 'address', name: 'oracle', type: 'address' }], stateMutability: 'nonpayable', type: 'constructor' }, { inputs: [], name: 'AgreementAlreadySigned', type: 'error' }, { inputs: [], name: 'EmptyArgs', type: 'error' }, { inputs: [], name: 'EmptySecrets', type: 'error' }, { inputs: [], name: 'EmptySource', type: 'error' }, { inputs: [], name: 'NoInlineSecrets', type: 'error' }, { inputs: [], name: 'ProjectDoesNotExist', type: 'error' }, { inputs: [], name: 'RequestIsAlreadyPending', type: 'error' }, { inputs: [], name: 'RequestIsNotPending', type: 'error' }, { inputs: [], name: 'SenderIsNotRegistry', type: 'error' }, {
  ...
  inputs: [{
    components: [{ internalType: 'enum Functions.Location', name: 'codeLocation', type: 'uint8' }, { internalType: 'enum Functions.Location', name: 'secretsLocation', type: 'uint8' }, { internalType: 'enum Functions.CodeLanguage', name: 'language', type: 'uint8' }, { internalType: 'string', name: 'source', type: 'string' }, { internalType: 'bytes', name: 'secrets', type: 'bytes' }, { internalType: 'string[]', name: 'args', type: 'string[]' }], internalType: 'struct Functions.Request', name: 'req', type: 'tuple',
  }, { internalType: 'uint64', name: 'subscriptionId', type: 'uint64' }, { internalType: 'uint32', name: 'gasLimit', type: 'uint32' }, { internalType: 'uint256', name: 'gasPrice', type: 'uint256' }],
  name: 'estimateCost',
  outputs: [{ internalType: 'uint96', name: '', type: 'uint96' }],
  stateMutability: 'view',
  type: 'function',
}, {
  inputs: [{ internalType: 'string', name: 'source', type: 'string' }, { internalType: 'bytes', name: 'secrets', type: 'bytes' }, { internalType: 'string[]', name: 'args', type: 'string[]' }, { internalType: 'uint64', name: 'subscriptionId', type: 'uint64' }, { internalType: 'uint32', name: 'gasLimit', type: 'uint32' }], name: 'executeRequest', outputs: [{ internalType: 'bytes32', name: '', type: 'bytes32' }], stateMutability: 'nonpayable', type: 'function',
}, {
  inputs: [], name: 'getDONPublicKey', outputs: [{ internalType: 'bytes', name: '', type: 'bytes' }], stateMutability: 'view', type: 'function',
}, {
  ...
  inputs: [{ internalType: 'bytes32', name: 'requestId', type: 'bytes32' }, { internalType: 'bytes', name: 'response', type: 'bytes' }, { internalType: 'bytes', name: 'err', type: 'bytes' }], name: 'handleOracleFulfillment', outputs: [], stateMutability: 'nonpayable', type: 'function',
}, {
  inputs: [{ internalType: 'address', name: '', type: 'address' }, { internalType: 'uint256', name: '', type: 'uint256' }], name: 'kolProjectMappings', outputs: [{ internalType: 'address', name: 'owner', type: 'address' }, { internalType: 'string', name: 'projectName', type: 'string' }], stateMutability: 'view', type: 'function',
}, {
  inputs: [], name: 'latestError', outputs: [{ internalType: 'bytes', name: '', type: 'bytes' }], stateMutability: 'view', type: 'function',
}, {
  inputs: [], name: 'latestRequestId', outputs: [{ internalType: 'bytes32', name: '', type: 'bytes32' }], stateMutability: 'view', type: 'function',
}, {
  inputs: [], name: 'latestResponse', outputs: [{ internalType: 'bytes', name: '', type: 'bytes' }], stateMutability: 'view', type: 'function',
}, {
  ...
  inputs: [{ internalType: 'address', name: 'oracle', type: 'address' }], name: 'updateOracleAddress', outputs: [], stateMutability: 'nonpayable', type: 'function',
}] as const;
